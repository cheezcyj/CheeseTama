...
This internal brief summarizes the implementation direction from the v1.7 planning document.

## Core Direction

CheeseTama is a PC-first cozy creature-raising simulation. The player checks in several times per day, cares for a CheeseTama egg, feeds milk-based items, manages status values, and gradually unlocks growth, collection, and room systems.
