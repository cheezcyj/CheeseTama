...
namespace CheeseTama.Platform
{
    ...
    public static class WebBrowserUxRuntime
    {
        ...
        public static bool HasGameStartShell(RuntimePlatform platform)
        {
        ...
        /// <summary>
        /// Returns the WebGL player to the outer game-start page. Other players keep using
        /// the Boot scene as their home because they do not have a browser shell.
        /// </summary>
        public static bool TryReturnToGameStart()
        {
#if UNITY_WEBGL && !UNITY_EDITOR
            CheeseTamaReturnToGameStart();
            return true;
#else
            return false;
#endif
        ...
        [DllImport("__Internal")]
        private static extern void CheeseTamaReturnToGameStart();
#endif
    }
}
