...
namespace CheeseTama.UI
{
    public sealed class ReturnSummaryController : MonoBehaviour
    {
        ...
        private void Populate(ReturnSummaryData summary)
        {
            ...
            AppendChange(changes, "배부름", summary.before.hunger, summary.after.hunger);
            AppendChange(changes, "기분", summary.before.mood, summary.after.mood);
            AppendChange(changes, "깨끗함", summary.before.cleanliness, summary.after.cleanliness);
            ...
            AppendChange(changes, "너무 배부름", summary.before.overfullness, summary.after.overfullness);
            SetText(
                changesText,
                changes.Length > 0
                    ? changes.ToString()
