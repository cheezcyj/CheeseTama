...
namespace CheeseTama.UI
{
    public sealed class NpcVisitCardController : MonoBehaviour
    {
        ...
        public void Configure(
            ...
            Image portraitGraphic = null)
        {
            overlayRoot = root;
            if (portraitGraphic != null)
            {
                portraitImage = portraitGraphic;
            }
            ...
            Action onLater = null)
        {
            ...
            ShowPortrait(offer.Visitor.Id, offer.Title);
        ...
        private void ShowPortrait(string npcId, string fallbackText)
        {
            SetText(portraitLabel, fallbackText);
            var portrait = portraitImage != null
                ? NpcPortraitCatalog.LoadPortrait(npcId)
                : null;
            var hasPortrait = portraitImage != null && portrait != null;
