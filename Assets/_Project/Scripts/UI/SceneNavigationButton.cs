...
namespace CheeseTama.UI
{
    ...
    public sealed class SceneNavigationButton : MonoBehaviour
    {
        ...
        [SerializeField] private bool returnToWebGameStart;
        ...
        public void Configure(string sceneName, bool shouldSaveBeforeLoad)
        {
            ...
            returnToWebGameStart = false;
            EnsureButtonListener();
        }

        public void ConfigureGameHome(string fallbackSceneName, bool shouldSaveBeforeLoad)
        {
            targetSceneName = fallbackSceneName;
            saveBeforeLoad = shouldSaveBeforeLoad;
            returnToWebGameStart = true;
            EnsureButtonListener();
        }
        ...
        {
            if (returnToWebGameStart
                && WebBrowserUxRuntime.HasGameStartShell(Application.platform))
            {
                ...
                if (WebBrowserUxRuntime.TryReturnToGameStart())
                {
                    return;
                }
            }
