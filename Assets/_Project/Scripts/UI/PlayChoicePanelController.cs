...
namespace CheeseTama.UI
{
    public sealed class PlayChoicePanelController : MonoBehaviour
    {
        ...
        [SerializeField] private BlueBallMiniGameController blueBallController;
        ...
        public void Configure(
            ...
            Button openMilkDropButton,
            Button openBouncyJumpButton,
            Button openBlueBallButton,
            Button closePanelButton,
            MilkDropMiniGameController milkDropMiniGame,
            BouncyJumpMiniGameController bouncyJumpMiniGame,
            BlueBallMiniGameController blueBallMiniGame,
            TopMenuController menuController = null,
            BottomActionBarController actionBarController = null,
            DevPanelController developerPanelController = null)
        {
        ...
        public bool Open()
        {
            ...
            SetText(rewardStatus.HasValue && rewardStatus.Value.isAvailable
                ? "우유방울 보상을 받을 수 있어요. 말랑 점프와 파란 공 놀이는 언제든 기록에 도전할 수 있어요."
                : "우유방울 받기는 연습할 수 있어요. 말랑 점프와 파란 공 놀이는 언제든 기록에 도전할 수 있어요.");
            SetActive(true);
            SuspendControls();
        ...
        private void OpenBlueBall()
        {
            Close();
            blueBallController ??= Object.FindFirstObjectByType<BlueBallMiniGameController>();
            blueBallController?.Open();
        }
        ...
        private void BindButtons()
        {
            ...
            if (blueBallButton != null)
            {
                blueBallButton.onClick.RemoveListener(OpenBlueBall);
                blueBallButton.onClick.AddListener(OpenBlueBall);
            }
