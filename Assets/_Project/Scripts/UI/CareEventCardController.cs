...
namespace CheeseTama.UI
{
    ...
    public sealed class CareEventCardController : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            var systemPrompt = overlayRoot.transform.parent?.Find("Mobile Landscape Prompt");
            if (systemPrompt != null && systemPrompt.gameObject.activeInHierarchy)
            {
                return;
            }
        ...
        private bool InvokeDirectRestAction()
        {
            var restButton = bottomActionBarController == null
                ? null
                : bottomActionBarController.transform.Find("Sleep Button")
                    ?.GetComponent<Button>();
            if (restButton == null
        ...
        private void BringOverlayToFront()
        {
            ...
            var parent = overlayTransform.parent;
            if (parent != null && overlayTransform.GetSiblingIndex() != parent.childCount - 1)
            {
