...
namespace CheeseTama.UI
{
    public sealed class TopMenuController : MonoBehaviour
    {
        ...
        {
            WireButtons();
            // Child modals temporarily disable this controller while keeping their
            // parent page visible. Re-enabling input must not close that parent.
            // Configure remains the single initialization boundary that clears stale
            // top-menu panels.
            RefreshCollectionRewardNotification(true);
        }
