...
namespace CheeseTama.UI
{
    public sealed class CookingPanelController : MonoBehaviour
    {
        ...
        {
            var text = string.Empty;
            text = AppendEffect(text, recipe.hunger, "배부름");
            text = AppendEffect(text, recipe.mood, "기분");
            text = AppendEffect(text, recipe.cleanliness, "깨끗함");
            ...
            text = AppendEffect(text, recipe.maturation, "성장");
