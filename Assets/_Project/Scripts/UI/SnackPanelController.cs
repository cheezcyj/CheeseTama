...
namespace CheeseTama.UI
{
    public sealed class SnackPanelController : MonoBehaviour
    {
        ...
        private void FeedSnack(SnackDefinition snack)
        {
            ...
            ResolveUiController()?.ShowMessage(
                MilkroomCareButton.FormatCareResultMessage(
                    MilkroomCareAction.FeedSnack,
                    careResult,
        ...
        private static string FormatEffect(SnackDefinition snack)
        {
            ...
            text = AppendEffect(text, snack.hunger, "배부름");
            text = AppendEffect(text, snack.mood, "기분");
            text = AppendEffect(text, snack.cleanliness, "깨끗함");
            ...
            text = AppendEffect(text, snack.maturation, "성장");
