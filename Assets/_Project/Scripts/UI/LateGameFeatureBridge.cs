...
namespace CheeseTama.UI
{
    ...
    public sealed class LateGameFeatureBridge : MonoBehaviour
    {
        ...
        [SerializeField] private StarLineagePanelController starLineagePanel;
        ...
        public void ConfigureStarLineage(StarLineagePanelController lineagePanel)
        {
            starLineagePanel = lineagePanel;
            starLineagePanel?.Refresh();
            RefreshGameplayBlock();
        }
        ...
        private void BindManager(GameManager manager)
        {
            ...
            if (boundManager != null)
            {
                ...
                boundManager.StarLineageChanged -= HandleStarLineageChanged;
        ...
        private void HandleStarLineageChanged()
        {
            RefreshAll();
        }
        ...
        private void HandleStarEggClicked()
        {
            ...
            RefreshAll();
            if (applied && manager.GetStarLineageSnapshot().RequiresTraitSelection)
            {
                starLineagePanel?.OpenFromEntry();
            }
        }
        ...
        private void RefreshStarEggButton(GameManager manager)
        {
            ...
            var visible = manager != null
                && manager.CurrentSave != null
                && manager.GetStarEggGenerationEligibility()
        ...
        private bool IsAnyLateGamePanelOpen()
        {
            return (starLegacyPanel != null && starLegacyPanel.IsBlockingGameplay)
                || (starLineagePanel != null && starLineagePanel.IsOpen)
