...
namespace CheeseTama.UI
{
    ...
    public sealed class MemoryJournalPanelController : MonoBehaviour
    {
            ...
            DevPanelController developerPanelController = null)
        {
            ...
            entriesScrollRect = journalScrollRect;
        ...
        public void Open()
        {
            ...
            openedFromProfile = profile != null
                && profile.BeginNestedChildNavigation(ProfileChildPage.MemoryJournal);
        ...
        public void Close()
        {
            ...
            {
                profile?.ReturnFromNestedChildNavigation(ProfileChildPage.MemoryJournal);
            }
