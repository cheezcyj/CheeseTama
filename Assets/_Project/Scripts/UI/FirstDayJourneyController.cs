...
namespace CheeseTama.UI
{
    public sealed class FirstDayJourneyController : MonoBehaviour
    {
        ...
        public const string BodyScrollViewObjectName = "First Day Journey Body Scroll View";
        public const string BodyViewportObjectName = "First Day Journey Body Viewport";
        public const string BodyContentObjectName = "First Day Journey Body Content";
        public const string EntryNotificationBadgeObjectName = "First Day Gift Notification Badge";
        ...
        [SerializeField] private GameObject entryNotificationBadge;
        ...
        public void Refresh()
        {
            ...
            if (!available)
            {
                SetEntryNotificationVisible(false);
                Close();
                return;
            }
            ...
            SetEntryNotificationVisible(state.completed && !state.rewardClaimed);
        ...
        private void EnsureEntryNotificationBadge()
        {
            ...
            var existing = openButton.transform.Find(EntryNotificationBadgeObjectName);
            if (existing != null && existing.GetComponent<RectTransform>() == null)
            {
                existing.name = EntryNotificationBadgeObjectName + " Legacy";
            ...
            {
                entryNotificationBadge = new GameObject(
                    EntryNotificationBadgeObjectName,
                    typeof(RectTransform));
                entryNotificationBadge.transform.SetParent(openButton.transform, false);
            }
            ...
            var badgeImage = entryNotificationBadge.GetComponent<Image>()
                ?? entryNotificationBadge.AddComponent<Image>();
            ...
            var outline = entryNotificationBadge.GetComponent<Outline>()
                ?? entryNotificationBadge.AddComponent<Outline>();
        ...
        private void SetEntryNotificationVisible(bool visible)
        {
            if (entryNotificationBadge != null
                && entryNotificationBadge.activeSelf != visible)
            {
                entryNotificationBadge.SetActive(visible);
            }
        }
