    ...
    public static class GameInputBindingSystem
    {
        ...
        public static string FormatKey(KeyCode key)
        {
            return key switch
            {
                ...
                KeyCode.Alpha5 => "5",
                KeyCode.Alpha6 => "6",
                KeyCode.Keypad0 => "숫자패드 0",
                KeyCode.Keypad1 => "숫자패드 1",
                KeyCode.Keypad2 => "숫자패드 2",
                KeyCode.Keypad3 => "숫자패드 3",
                KeyCode.Keypad4 => "숫자패드 4",
                KeyCode.Keypad5 => "숫자패드 5",
                KeyCode.Keypad6 => "숫자패드 6",
                KeyCode.Keypad7 => "숫자패드 7",
                KeyCode.Keypad8 => "숫자패드 8",
                KeyCode.Keypad9 => "숫자패드 9",
                KeyCode.Escape => "Esc",
                KeyCode.Return => "Enter",
                KeyCode.KeypadEnter => "숫자패드 Enter",
                KeyCode.Space => "스페이스바",
                ...
                KeyCode.LeftAlt => "왼쪽 Alt",
                KeyCode.RightAlt => "오른쪽 Alt",
                KeyCode.Backspace => "뒤로 지우기",
                KeyCode.Delete => "Delete",
                KeyCode.Home => "처음으로",
                KeyCode.End => "끝으로",
                KeyCode.PageUp => "한 페이지 위",
                KeyCode.PageDown => "한 페이지 아래",
                _ => key.ToString()
            };
        }
