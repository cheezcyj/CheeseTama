...
namespace CheeseTama.Gameplay.Growth
{
    ...
    public sealed class FinalMaturationCycleSystem
    {
        ...
        public FinalMaturationReward CreateReward(
            ...
            bool fantasyPowderEnabled)
        {
            return CreateReward(cycleNumber, starRouteUnlocked, fantasyPowderEnabled, 0);
        }
            ...
            int starDropRewardBonus)
        {
            ...
            var baseStarDrops = starRouteUnlocked
                && normalizedCycle % StarDropRewardInterval == 0 ? 1 : 0;
            return new FinalMaturationReward(
                ...
                baseStarDrops <= 0
                    ...
                    : (int)Math.Min(
                        int.MaxValue,
                        (long)baseStarDrops + Math.Max(0, starDropRewardBonus)),
