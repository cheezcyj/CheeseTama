namespace CheeseTama.Gameplay.Decorations
{
    ...
    public sealed class DecorationDefinition
    {
            ...
            string visualKey)
        {
            ...
            this.collectionFragmentCost = collectionFragmentCost < 0 ? 0 : collectionFragmentCost;
        ...
        public readonly int collectionFragmentCost;
        ...
        public bool IsFree => milkCoinCost == 0
            && milkDropCost == 0
